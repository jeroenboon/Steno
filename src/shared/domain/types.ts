...
export const MeetingSchema = z.object({
  ...
  /**
   * Whether the title is an auto-generated placeholder (the quick-start
   * "Direct starten" path sets this true with a date/time title). The final pass
   * may replace such a title with an inferred one, then clear the flag; any user
   * edit of the title also clears it. Defaults to false so user-set and existing
   * titles are never overwritten. See ADR 0029.
   */
